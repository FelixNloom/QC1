...
if ($gameVariables.value(1) == 8)
...
else if ($gameVariables.value(1) == 7)
	{
		...
		{
			$gameVariables.setValue(75, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(76, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(77, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 6)
		{
			$gameVariables.setValue(78, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(79, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(80, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 5)
		{
			$gameVariables.setValue(81, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(81, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(83, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 4)
		{
			$gameVariables.setValue(84, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(85, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(86, $gameVariables.value(5)); //saves loot
		}	
	}
else if ($gameVariables.value(1) == 6)
	{
		if ($gameVariables.value(2) == 8)
		{
			$gameVariables.setValue(87, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(88, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(89, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 7)
		{
			$gameVariables.setValue(90, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(91, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(92, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 6)
		{
			$gameVariables.setValue(93, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(93, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(95, $gameVariables.value(5)); //saves loot
		}
		else if ($gameVariables.value(2) == 5)
		{
			$gameVariables.setValue(96, $gameVariables.value(3)); //saves room
			$gameVariables.setValue(97, $gameVariables.value(4)); //saves monster
			$gameVariables.setValue(98, $gameVariables.value(5)); //saves loot
		}
...
else if ($gameVariables.value(1) == 5)
	{
		...
		else if ($gameVariables.value(2) == 4)
		{
			...
			$gameVariables.setValue(115, $gameVariables.value(4)); //saves monster
